...
beq_cont.5899:
	...
	lwz	r2, 8(r3)
	cmpwi	cr7, r2, 4
	bgt	cr7, ble_else.5903
	lis	r31, ha16(l.4857)
	addi	r31, r31, lo16(l.4857)
	lfd	f0, 0(r31)
	lfd	f1, 0(r3)
	fcmpu	cr7, f1, f0
	bgt	cr7, ble_else.5904
	blr
ble_else.5904:
	lis	r31, ha16(l.4858)
