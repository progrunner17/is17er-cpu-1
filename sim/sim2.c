...
void exec(struct Prog *prog,int *mem,float *fmem,int *reg,float *freg,int *label,int pc_max){
  ...
  while(pc<pc_max){
	...
	pc=search_label(prog[pc].adr,label,prog);
      ...
      mem[reg[prog[pc].rs2]+prog[pc].imm]=reg[prog[pc].rs1];
      pc=pc+4;
      ...
      i1 = reg[prog[pc].rs1];
      i2 = reg[prog[pc].rs2];
      reg[prog[pc].rd] = (i1 < i2) ? 1 : 0;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"sltu")==0){
      u1 = reg[prog[pc].rs1];
      u2 = reg[prog[pc].rs2];
      reg[prog[pc].rd] = (u1 < u2) ? 1 : 0;
      pc = pc+4;
      ...
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"flw")==0){
      reg[prog[pc].rd]=fmem[reg[prog[pc].rs1]+prog[pc].imm];
      pc=pc+4;
    }else if(strcmp(prog[pc].nmc,"fsw")==0){
      fmem[reg[prog[pc].rs2]+prog[pc].imm]=freg[prog[pc].rs1];
      pc=pc+4;
    }else if(strcmp(prog[pc].nmc,"fadd")==0){
      fx = freg[prog[pc].rs1];
      fy = freg[prog[pc].rs2];
      freg[prog[pc].rd] = fx+fy;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"fsub")==0){
      fx = freg[prog[pc].rs1];
      fy = freg[prog[pc].rs2];
      freg[prog[pc].rd] = fx - fy;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"fmul")==0){
      fx = freg[prog[pc].rs1];
      fy = freg[prog[pc].rs2];
      freg[prog[pc].rd] = fx*fy;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"fdiv")==0){
      x = freg[prog[pc].rs1];
      y = freg[prog[pc].rs2];
      freg[prog[pc].rd] = fx/fy;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"fsqrt")==0){
      fx = freg[prog[pc].rs1];
      freg[prog[pc].rd] = sqrt(fx);
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"itof")==0){
      i1 = freg[prog[pc].rs1];
      reg[prog[pc].rd] = i1;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"feq.s")==0){
      fx = freg[prog[pc].rs1];
      fy = freg[prog[pc].rs2];
      freg[prog[pc].rd] = (fx=fy)?1:0;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"flt.s")==0){
      fx = freg[prog[pc].rs1];
      fy = freg[prog[pc].rs2];
      freg[prog[pc].rd] = (fx < fy)?1:0;
      pc = pc+4; 
    }else if(strcmp(prog[pc].nmc,"fle.s")==0){
      fx = freg[prog[pc].rs1];
      fy = freg[prog[pc].rs2];
      freg[prog[pc].rd] = (fx < fy)?1:0;;
      pc = pc+4;
    }else if(strcmp(prog[pc].nmc,"ftoi")==0){
      fx = reg[prog[pc].rs1];
      freg[prog[pc].rd] = fx;
      pc = pc+4;
    }
...
int main(int argc, char** argv){
  ...
  while((fscanf(input,"%s",opc)) != EOF){
    ...
    if(strcmp(opc,"lui")==0){
      ...
      scanf("%c%d%c %c%d",&rd,&n1,&comma1,&rs1,&n2);
      prog[pc].rd = n1;
      prog[pc].rs1 = n2;
    }else if(strcmp(prog[pc].nmc,"itof")==0){
      scanf("%c%d%c %c%d",&rd,&n1,&comma1,&rs1,&n2);
      ...
      scanf("%c%d%c %c%d",&rs1,&n1,&comma1,&rs2,&n2);
      prog[pc].rs1 = n1;
      prog[pc].rs2 = n2;
    }else if(strcmp(prog[pc].nmc,"flt.s")==0){
      scanf("%c%d%c %c%d",&rs1,&n1,&comma1,&rs2,&n2);
  ...
  exec(prog,mem,fmem,reg,freg,label,pc);
